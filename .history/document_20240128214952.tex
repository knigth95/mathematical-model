...
\subsection{公式编辑和引用}
    1.太阳高度角 
    $\begin{aligned} & \alpha_s \text { [3] } \\ & \gamma_s \text { [4] } \\ & \sin \alpha_s=\cos \delta \cos \varphi \cos \omega+\sin \delta \sin \varphi \\ & \cos \gamma_s=\frac{\sin \delta-\sin \alpha_s \sin \varphi}{\cos \alpha_s \cos \varphi}\end{aligned}$
