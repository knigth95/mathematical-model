...
\subsection{公式编辑和引用}
    \setlength{\parindent}{2em}%另起一段并空两格
    1. 太阳高度角 \(\alpha_{s}\) [3] 
    %单独显示公式要加\[\]
	...
	算公式(14)如下：
	$$
	\begin{array}{c}{{D N I=G_{0}\left[a+b\exp\left(\frac{-c}{\sin\alpha_{s}}\right)\right],}}\\ {{a=0.4237-0.00821(6-H)^{2}}}\\ {{b=0.505+0.00566.5-H)^{2}}}\\ {{c=0.271+0.01858(2.57-H)^{2}}}\end{array}(14)
	$$
